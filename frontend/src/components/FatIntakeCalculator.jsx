  ...
  const generateRecommendations = (fatPercentage, cholesterol, heartHealth, goal) => {
    ...
    if (cholesterol === "high") {
      recommendations.push({
        ...
        message: "Limit saturated fat to less than 7% of calories and avoid trans fats. Focus on omega-3 fatty acids and monounsaturated fats."
      });
    }
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select value={formData.cholesterolLevel} onValueChange={(value) => handleInputChange("cholesterolLevel", value)}>
                    ...
                    <SelectContent className="bg-gray-800 border-gray-700">
                      <SelectItem value="optimal">Optimal (less than 200 mg/dL)</SelectItem>
            ...
            <div className="bg-gray-800/50 p-3 sm:p-4 md:p-6 rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-red-900/20 rounded-lg border border-red-800/30">
                  ...
                  <div className="text-xs text-gray-400 mt-2">Less than 10% of total calories</div>
                </div>

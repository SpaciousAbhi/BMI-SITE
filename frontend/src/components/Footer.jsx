          ...
          <div className="bg-gray-800/20 rounded-lg p-6 border border-gray-700/30">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-bold text-white">Blogs & Articles</h3>
              </div>
              <div className="flex items-center gap-4 text-sm">
                <span className="text-blue-400 font-medium">5 Articles</span>
                <span className="text-gray-400">•</span>
                <span className="text-gray-400">Expert Guides</span>
              </div>
            </div>
            
            <p className="text-gray-400 text-sm mb-4">BMI, nutrition, fitness & health calculator guides with medical insights</p>
            
            <Link
              to="/blogs-articles"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 text-white font-medium px-4 py-2 rounded-lg transition-all duration-300 hover:shadow-lg text-sm"
            >

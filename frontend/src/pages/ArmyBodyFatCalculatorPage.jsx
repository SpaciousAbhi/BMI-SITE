        ...
        <div className="mt-12 max-w-4xl mx-auto">
          ...
          <div className="mt-8 bg-gray-900/30 p-6 rounded-xl">
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-slate-400">17-20 years</span>
                    <span className="text-white">20%</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">21-27 years</span>
                    <span className="text-white">22%</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">28-39 years</span>
                    <span className="text-white">24%</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">40+ years</span>
            ...
            <div className="mt-6 p-4 bg-green-900/20 rounded-lg border border-green-800/50">
              <p className="text-sm glass-text opacity-90">

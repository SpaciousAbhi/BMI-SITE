          ...
          <div className="mt-8 bg-gray-900/30 p-6 rounded-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-slate-400">Men - Essential Fat:</span>
                    <span className="text-white">2-5%</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Men - Athletic:</span>
                    <span className="text-white">6-13%</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Men - Fitness:</span>
                    <span className="text-white">14-17%</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Men - Average:</span>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-slate-400">Women - Essential Fat:</span>
                    <span className="text-white">10-13%</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Women - Athletic:</span>
                    <span className="text-white">14-20%</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Women - Fitness:</span>
                    <span className="text-white">21-24%</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Women - Average:</span>

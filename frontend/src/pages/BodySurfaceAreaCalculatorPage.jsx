              ...
              <div>
                ...
                <div className="space-y-3 text-sm">
                  <div className="p-4 bg-cyan-900/20 rounded-lg border border-cyan-800/30">
                    ...
                    <div className="text-slate-400 mb-2">The original and most widely used formula</div>
                  ...
                  <div className="p-4 bg-blue-900/20 rounded-lg border border-blue-800/30">
                    ...
                    <div className="text-slate-400 mb-2">Simple square root formula</div>
                    <ul className="text-xs text-slate-500 space-y-1">
              ...
              <div>
                ...
                <div className="space-y-3 text-sm">
                  <div className="p-4 bg-blue-900/20 rounded-lg border border-blue-800/30">
                    ...
                    <div className="text-slate-400 mb-2">Optimized for pediatric populations</div>
                    <ul className="text-xs text-slate-500 space-y-1">
                  ...
                  <div className="p-4 bg-indigo-900/20 rounded-lg border border-indigo-800/30">
                    ...
                    <div className="text-slate-400 mb-2">General population studies</div>
                    <ul className="text-xs text-slate-500 space-y-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-slate-400">Small Adult</span>
                    <span className="text-white">1.4 - 1.6</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Average Adult</span>
                    <span className="text-white">1.6 - 2.0</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Large Adult</span>
                    <span className="text-white">2.0 - 2.4</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Very Large Adult</span>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-slate-400">Newborn</span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-slate-400">15 Years</span>

            ...
            <div className="prose prose-gray prose-invert max-w-none">
              ...
              <div className="bg-orange-900/20 border border-orange-800/30 p-4 sm:p-6 rounded-lg mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                  <ul className="glass-text opacity-90 space-y-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a href="/pace-calculator" className="block p-4 glass-panel glow-border rounded-lg hover:bg-gray-800/70 transition-colors">
                  ...
                  <p className="glass-text opacity-90 text-sm">Calculate running pace and get race predictions with VDOT analysis.</p>
                </a>
                <a href="/target-heart-rate-calculator" className="block p-4 glass-panel glow-border rounded-lg hover:bg-gray-800/70 transition-colors">
                  ...
                  <p className="glass-text opacity-90 text-sm">Find your optimal heart rate zones for different training intensities.</p>
                </a>
              </div>
            </div>
          </div>

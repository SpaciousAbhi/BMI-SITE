...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Compact Blogs & Articles Section */}
      <section className="py-8 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-900/20 to-teal-900/20 border-y border-gray-800/50">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-6">
            <h2 className="text-2xl md:text-3xl font-bold mb-3 bg-gradient-to-r from-blue-400 to-teal-400 bg-clip-text text-transparent">
              Blogs & Articles
            </h2>
            <p className="text-gray-300 mb-4">Expert health insights & comprehensive calculator guides</p>
          </div>
          ...
          <div className="flex justify-center items-center gap-8 mb-6">
            ...
            <div className="text-center">
              <div className="text-xl font-bold text-purple-400">14m</div>
          ...
          <div className="text-center">
            <a
              href="/blogs-articles"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-teal-600 hover:from-blue-700 hover:to-teal-700 text-white font-medium px-6 py-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 group"
            >

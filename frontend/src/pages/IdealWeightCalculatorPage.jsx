            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="space-y-3 text-sm">
                  <div className="p-3 glass-panel glow-border rounded-lg">
                    <div className="font-medium text-white mb-1">Devine Formula</div>
                    <div className="text-slate-400">Medical gold standard, widely used in clinical practice</div>
                  </div>
                  <div className="p-3 glass-panel glow-border rounded-lg">
                    <div className="font-medium text-white mb-1">Robinson Formula</div>
                    <div className="text-slate-400">Modified Devine with adjusted constants</div>
                  </div>
                  <div className="p-3 glass-panel glow-border rounded-lg">
                    <div className="font-medium text-white mb-1">Miller Formula</div>
                    <div className="text-slate-400">Alternative medical approach with different coefficients</div>
                  </div>
                </div>
              </div>
              <div>
                ...
                <div className="space-y-3 text-sm">
                  <div className="p-3 glass-panel glow-border rounded-lg">
                    ...
                    <div className="text-slate-400">Quick estimation method used in dietetics</div>
                  </div>
                  <div className="p-3 glass-panel glow-border rounded-lg">
                    <div className="font-medium text-white mb-1">Broca Formula</div>
                    <div className="text-slate-400">Traditional European method, height-based</div>
                  </div>
                  <div className="p-3 glass-panel glow-border rounded-lg">
                    <div className="font-medium text-white mb-1">BMI-Based</div>
                    <div className="text-slate-400">Uses optimal BMI of 22, gender-neutral approach</div>
                  </div>
                </div>
              </div>
            </div>

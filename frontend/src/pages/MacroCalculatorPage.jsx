          ...
          <div className="glass-panel glow-border rounded-xl border border-gray-800 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-green-900/20 p-6 rounded-lg border border-green-800/50">
                ...
                <p className="glass-text opacity-90 mb-3">
                  <strong>4 calories per gram</strong>
                </p>
                <ul className="glass-text opacity-90 space-y-2 text-sm">
            ...
            <div className="mt-8 p-6 glass-panel glow-border rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="glass-text opacity-90 text-sm mb-3">40% carbs, 30% protein, 30% fat - General health and maintenance</p>
                  
                  <h4 className="font-semibold text-white mb-2">High Protein (30/35/35)</h4>
                  <p className="glass-text opacity-90 text-sm mb-3">30% carbs, 35% protein, 35% fat - Muscle building and fat loss</p>

                  <h4 className="font-semibold text-white mb-2">Low Carb (20/30/50)</h4>
                  <p className="glass-text opacity-90 text-sm">20% carbs, 30% protein, 50% fat - Fat loss and metabolic health</p>
                </div>
                <div>
                  <h4 className="font-semibold text-white mb-2">High Carb (60/20/20)</h4>
                  <p className="glass-text opacity-90 text-sm mb-3">60% carbs, 20% protein, 20% fat - Endurance athletes</p>
                  
                  <h4 className="font-semibold text-white mb-2">Ketogenic (5/25/70)</h4>
                  <p className="glass-text opacity-90 text-sm mb-3">5% carbs, 25% protein, 70% fat - Rapid fat loss, therapeutic</p>

                  <h4 className="font-semibold text-white mb-2">Mediterranean (45/20/35)</h4>
                  <p className="glass-text opacity-90 text-sm">45% carbs, 20% protein, 35% fat - Heart health and longevity</p>
                </div>
              </div>
            </div>

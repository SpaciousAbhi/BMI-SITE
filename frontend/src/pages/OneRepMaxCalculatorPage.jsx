    ...
    <div className="min-h-screen bg-black text-white py-6 sm:py-8">
      <div className="container mx-auto px-3 sm:px-4 lg:px-8">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-lg sm:text-xl glass-text opacity-90 max-w-3xl mx-auto px-3">
        ...
        <div className="mt-12 sm:mt-16 max-w-4xl mx-auto space-y-8 sm:space-y-12">
          ...
          <div className="bg-gray-900/30 rounded-xl p-6 sm:p-8">
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-purple-500 pl-4">
                ...
                <p className="glass-text opacity-90 text-sm sm:text-base">
          ...
          <div className="bg-gray-900/30 rounded-xl p-6 sm:p-8">
            ...
            <div className="prose prose-gray prose-invert max-w-none">
              <p className="glass-text opacity-90 mb-4 text-sm sm:text-base">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                <div className="glass-panel glow-border p-4 rounded-lg">
                  ...
                  <ul className="glass-text opacity-90 space-y-2 text-sm sm:text-base">
              ...
              <div className="space-y-4 glass-text opacity-90 mb-6">
              ...
              <div className="bg-red-900/20 border border-red-800/30 p-4 sm:p-6 rounded-lg mb-6">
                ...
                <ol className="glass-text opacity-90 space-y-2 text-sm sm:text-base">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                <div className="glass-panel glow-border p-4 rounded-lg">
                  ...
                  <p className="glass-text opacity-90 text-sm">Increase weight by 2.5% when you can complete all prescribed reps with perfect form.</p>
                </div>
                <div className="glass-panel glow-border p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">Rep Progression</h4>
                  <p className="glass-text opacity-90 text-sm">Add one rep per week until you reach the top of your target rep range.</p>
                </div>
                <div className="glass-panel glow-border p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">Volume Progression</h4>
                  <p className="glass-text opacity-90 text-sm">Gradually increase total training volume through additional sets or frequency.</p>
                </div>
              </div>

              <h3 className="text-xl sm:text-2xl font-semibold text-white mt-6 mb-4">Supported Exercises:</h3>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 glass-text opacity-90 mb-6">
                <div className="glass-panel glow-border p-4 rounded-lg">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="glass-panel glow-border p-4 rounded-lg">
                  ...
                  <p className="glass-text opacity-90 text-sm">Set appropriate training loads for different goals using percentage-based programming.</p>
                </div>
                <div className="glass-panel glow-border p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">Progress Tracking</h4>
                  <p className="glass-text opacity-90 text-sm">Monitor strength gains over time and adjust training accordingly.</p>
                </div>
                <div className="glass-panel glow-border p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">Competition Prep</h4>
                  <p className="glass-text opacity-90 text-sm">Plan attempt selection for powerlifting meets and strength competitions.</p>
                </div>
                <div className="glass-panel glow-border p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">Periodization</h4>
                  <p className="glass-text opacity-90 text-sm">Adjust training intensity throughout different phases of your training cycle.</p>
                </div>
              </div>

              <h3 className="text-xl sm:text-2xl font-semibold text-white mt-8 mb-4">Related Calculators</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a href="/calories-burned-calculator" className="block p-4 glass-panel glow-border rounded-lg hover:bg-gray-800/70 transition-colors">
                  <h4 className="font-semibold text-orange-400 mb-2">Calories Burned Calculator</h4>
                  <p className="glass-text opacity-90 text-sm">Calculate calories burned during strength training sessions.</p>
                </a>
                <a href="/target-heart-rate-calculator" className="block p-4 glass-panel glow-border rounded-lg hover:bg-gray-800/70 transition-colors">
                  <h4 className="font-semibold text-red-400 mb-2">Target Heart Rate Calculator</h4>
                  <p className="glass-text opacity-90 text-sm">Monitor cardiovascular intensity during strength training.</p>
                </a>
              </div>
              ...
              <div className="bg-yellow-900/20 border border-yellow-800/30 p-4 sm:p-6 rounded-lg mt-8">
                ...
                <p className="text-sm sm:text-base glass-text opacity-90">

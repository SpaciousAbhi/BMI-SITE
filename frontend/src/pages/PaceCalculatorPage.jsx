          ...
          <div className="bg-gray-900/30 rounded-xl p-6 sm:p-8">
            ...
            <div className="prose prose-gray prose-invert max-w-none">
              ...
              <div className="glass-panel glow-border p-4 sm:p-6 rounded-lg mb-6">
                <ol className="glass-text opacity-90 space-y-3 text-sm sm:text-base">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="glass-panel glow-border p-4 rounded-lg">
                  ...
                  <p className="glass-text opacity-90 text-sm">Set realistic goals for upcoming races based on your current fitness level and race predictions.</p>
                </div>
                <div className="glass-panel glow-border p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">Training Paces</h4>
                  <p className="glass-text opacity-90 text-sm">Determine appropriate paces for different workout types including easy runs, tempo runs, and intervals.</p>
                </div>
                <div className="glass-panel glow-border p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">Progress Tracking</h4>
                  <p className="glass-text opacity-90 text-sm">Monitor fitness improvements over time by tracking changes in your VDOT score.</p>
                </div>
                <div className="glass-panel glow-border p-4 rounded-lg">
                  <h4 className="font-semibold text-white mb-2">Race Strategy</h4>
                  <p className="glass-text opacity-90 text-sm">Plan pacing strategies for optimal performance in races of any distance.</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a href="/calories-burned-calculator" className="block p-4 glass-panel glow-border rounded-lg hover:bg-gray-800/70 transition-colors">
                  ...
                  <p className="glass-text opacity-90 text-sm">Calculate calories burned during your running sessions using advanced MET values.</p>
                </a>
                <a href="/target-heart-rate-calculator" className="block p-4 glass-panel glow-border rounded-lg hover:bg-gray-800/70 transition-colors">
                  ...
                  <p className="glass-text opacity-90 text-sm">Determine optimal heart rate zones for different training intensities.</p>
                </a>
              </div>
            </div>
          </div>

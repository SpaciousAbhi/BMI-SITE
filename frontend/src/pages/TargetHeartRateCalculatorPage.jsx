            ...
            <div className="prose prose-gray prose-invert max-w-none">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                <div className="glass-panel glow-border p-4 rounded-lg">
                  ...
                  <p className="glass-text opacity-90 text-sm sm:text-base">Uses resting heart rate for personalized accuracy. Formula: ((Max HR - Resting HR) × %Intensity) + Resting HR</p>
                </div>
                <div className="glass-panel glow-border p-4 rounded-lg">
                  <h4 className="font-semibold text-pink-300 mb-2">Age-Based Formulas</h4>
                  <p className="glass-text opacity-90 text-sm sm:text-base">Includes Tanaka, Gulati (women), and traditional 220-age formulas for different populations and accuracy needs.</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 glass-text opacity-90 mb-6">
                <div className="glass-panel glow-border p-4 rounded-lg">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                <div className="glass-panel glow-border p-4 rounded-lg">
                  ...
                  <ul className="glass-text opacity-90 space-y-1 text-sm">
              ...
              <div className="bg-yellow-900/20 border border-yellow-800/30 p-4 sm:p-6 rounded-lg mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <ul className="glass-text opacity-90 mt-1 space-y-1">
              ...
              <div className="glass-panel glow-border p-4 sm:p-6 rounded-lg mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                  <div className="text-center p-3 bg-green-900/20 rounded-lg">
                    ...
                    <div className="text-slate-400 text-xs mt-1">Zones 1-2</div>
                    <p className="glass-text opacity-90 mt-2">Base building, recovery, fat burning</p>
                  </div>
                  <div className="text-center p-3 bg-yellow-900/20 rounded-lg">
                    ...
                    <div className="text-slate-400 text-xs mt-1">Zone 3</div>
                    <p className="glass-text opacity-90 mt-2">Aerobic development, tempo work</p>
                  </div>
                  <div className="text-center p-3 bg-red-900/20 rounded-lg">
                    ...
                    <div className="text-slate-400 text-xs mt-1">Zones 4-5</div>
                    <p className="glass-text opacity-90 mt-2">High-intensity, VO2 max work</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a href="/calories-burned-calculator" className="block p-4 glass-panel glow-border rounded-lg hover:bg-gray-800/70 transition-colors">
                  ...
                  <p className="glass-text opacity-90 text-sm">Calculate calories burned in different heart rate zones during exercise.</p>
                </a>
                <a href="/pace-calculator" className="block p-4 glass-panel glow-border rounded-lg hover:bg-gray-800/70 transition-colors">
                  <h4 className="font-semibold text-blue-400 mb-2">Pace Calculator</h4>
                  <p className="glass-text opacity-90 text-sm">Determine running paces for different heart rate training zones.</p>
                </a>
              </div>

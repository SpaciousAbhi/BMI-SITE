  ...
  const sections = [
    {
      ...
      content: [
        "By accessing and using BMI Pro, you accept and agree to be bound by these Terms of Service",
    ...
    },
    {
      ...
      content: [
        "BMI Pro provides BMI (Body Mass Index) calculation tools and health-related information",
          ...
          <Card className={`mb-8 backdrop-blur-md border-0 shadow-xl ${
            ...
            <CardContent className="p-6">
              <p className={`text-lg leading-relaxed ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
                Welcome to BMI Pro. These Terms of Service govern your use of our website and BMI calculation services. 
          ...
          <Card className={`mt-8 backdrop-blur-md border-0 shadow-xl ${
            ...
            <CardContent className="space-y-4">
              <div className={theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}>
                <p className="mb-4">
                  All content, features, and functionality of BMI Pro, including but not limited to:
                </p>
